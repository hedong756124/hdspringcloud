...
import com.honghu.cloud.common.code.ResponseVO;
 ...
 /**
 * Auction Response Code
 * @author wsp
 * @version 2018-04-25
 */
public enum AuctionResponseCode  {
	//操作成功
    ...
    // 构造方法  
    private AuctionResponseCode(String code,String message) {  
        this.code = code;  
	...
	public static ResponseVO buildEnumResponseVO(AuctionResponseCode auctionResponseCode, Object data) {
		return new ResponseVO(auctionResponseCode.getCode(),auctionResponseCode.getMessage(),data);
	}
	
	public static Map<String, Object> buildReturnMap(AuctionResponseCode responseCode, Object data) {
